...
const S_photography = () => {
  ...
  return (
    <div className="S_photography landing">
      ...
      <Pattern9 />  
      <SliderHOME schema={ImageGalleryPotographySchema} DATA={ImageGalleryPotography}  typeOf="Videograph" title= {t("home.Home_Header.name")}   header1={t("photo.header",{returnObjects:true})}   />
    

      <Pattern9 />
      <Serach2 Img ={IMG1} Imgsection ={Grid1} title ={t("photo.why.title")} data={WHY} />

      <Contact number={3} title={t("photo.footer.title")} desc=" " />

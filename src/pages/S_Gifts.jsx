...
import Icon_1 from "../assets/S_gifts/offer1.webp" ;
import Icon_2 from "../assets/S_gifts/offer2.webp" ;
import Icon_3 from "../assets/S_gifts/offer3.webp" ;
import Icon_4 from "../assets/S_gifts/offer4.webp" ;


import gifts_1 from "../assets/S_gifts/gifts1.webp" ;
import gifts_2 from "../assets/S_gifts/gifts2.webp" ;
import gifts_3 from "../assets/S_gifts/gifts3.webp" ;
...
const S_Gifts = memo(() => {
  ...
  return (
    <div className="S_Gifts landing">
      ...
      <SliderHOME schema={ImageGalleryGiftsSchema} DATA={ImageGalleryGifts} typeOf="trophies"  title={t("gifts.gallery.title")}   header1={t("gifts.gallery.header" , {returnObjects:true})} />


      <Divider classn="divider-left" />
      <Impact classn="impact" Img={IMG3}  data={BRANDING_SERVICES}  title=  {t("gifts.impact.title")}  nameServices="gifts services"  />

      <Contact number={6} title=  {t("gifts.contact.title")} desc=  {t("gifts.contact.desc")} />
      <Footer />
      </div>
  )
})

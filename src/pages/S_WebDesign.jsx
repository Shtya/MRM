...
<div className="WEB_DESIGN landing" >
      ...
      <div className="home">
        ...
        <Pattern9 />
        <Social_media  data={SocialMedia} Img={IMG1} title={t("WebDesign.Socialmedia.title")} desc={t("WebDesign.Socialmedia.desc")} />
        ...
        <Pattern9 />
        <SliderHOME title={t("home.Home_Header.name")}DATA={ImageGalleryWeb} typeOf="Web" schema={ImageGalleryWebSchema}   /> 


      
        <Contact number={4} desc={t("WebDesign.footer.title")} title={t("WebDesign.footer.desc")} />

  ...
  return (
    <div className="S_Branding landing">
      ...
      <Divider classn="divider" />
       <SliderHOME schema={ImageGalleryBrandingSchema} DATA={ImageGalleryBranding} typeOf="Logo" classHeader="header4" title={t("brand.gallery.title")}   header1={t("brand.gallery.header",{returnObjects:true})} />
      ...
      <Contact number={8} title={t("brand.contact.title")} desc={t("brand.contact.desc")} />
      <Footer />
      </div>
  )
}

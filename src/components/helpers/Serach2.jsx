...
const Serach2 = memo(({Img , Imgsection ,title , data ,}) => {
  return (
    <div className="searching2">
        <div className="bgCover" data-aos="zoom-in-left"  >  <img  src={Img} alt="photography services" loading="lazy" /> </div>
            <div className="container">
              <div className="coverImg "> <img src={Imgsection} alt="photography services" loading="lazy" /> </div>

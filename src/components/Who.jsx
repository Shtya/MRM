...
const Who =memo(() => {
  ...
  return(
    <section className="Who search-edite " id='who' >
      <Animation />
      <div className="bgCover"  >  <img  src={IMG1} alt="who" width={30} height={30}  /> </div>
      <div className="container">

      <div className="Img " >
        <img data-aos={Animate}  width={30} height={30}  src={About_us} alt="Professionals collaborating in office, framed by letter-shaped windows"   />
      </div>
      ...
      <div className="box" data-aos={Animate}  >
        ...
        <button onClick={_=> navigate("/about-us")} className='bt ' data-aos={Animate} data-aos-delay="100" >{t("home.Home_section1.bt")}</button>
      </div>
      </div>
    </section>
  )

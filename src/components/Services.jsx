...
const services = [
  ...
  {route:"/web-development-company-in-dubai", animate:"fade-up",  title:"web design & Development "    , icon:"clip  fa-solid fa-pen-nib"          ,desc:"We transform your online presence with responsive web design, e-commerce solutions, and ongoing maintenance" ,                   },
  ...
  {route:"/Photography-In-Dubai",animate:"fade-up",  title:"photography & videography "   , icon:"clip  fa-regular fa-circle-play"    ,desc:"We offer captivating visuals for your marketing. our high-quality images and videos tell a story that engages your audience." ,       },
  ...
  {route:"/advertising-ppc-agency-in-dubai",      animate:"fade-up",  title:"media buying"                 , icon:"clip  fa-solid fa-shop"             ,desc:"Maximize online reach with effective advertising. Optimize campaigns with social media and Google Ads."    ,                              },

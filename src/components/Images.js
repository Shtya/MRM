...
import clients38 from "../assets/png/(33).png"
import clients39 from "../assets/png/(19).png"
import clients40 from "../assets/png/(20).png"
import clients41 from "../assets/png/(21).png"
import clients42 from "../assets/png/(22).png"
import clients43 from "../assets/png/(23).png"
import clients44 from "../assets/png/(24).png"
import clients45 from "../assets/png/(25).png"
import clients46 from "../assets/png/(26).png"
import clients47 from "../assets/png/(27).png"
import clients48 from "../assets/png/(28).png"
import clients49 from "../assets/png/(29).png"
import clients50 from "../assets/png/(30).png"
import clients51 from "../assets/png/(31).png"
import clients52 from "../assets/png/(32).png"





export function ImgsClients (){
  return [
    clients18 ,clients20 ,clients22 ,clients23 ,clients24 ,clients25 ,clients26 ,clients27 ,clients28 ,clients29 ,clients30 ,clients31 ,clients32 ,clients33 ,clients34 ,clients35 ,clients36  ,clients38 ,clients39 ,clients40 ,clients41 ,clients42 ,clients43 ,clients44 ,clients45 ,clients46 ,clients47 ,clients48 ,clients49 ,clients50 ,clients51 ,clients52 ,
  ]
}
...
export function ImgsPortfolio (headers) {
 return [
  ...
  {img:  Sign4 , type:`${headers[1]} ` }  ,
  {img:  Sign5 , type:`${headers[1]} ` }  ,
  ...
  {img: DisplayStand3   , type:`${headers[2]} ` }  ,
  {img: DisplayStand4   , type:`${headers[2]} ` }  ,
  ...
  {img:  Exhibition4   , type:`${headers[3]} ` }  ,
  {img:  Exhibition5   , type:`${headers[3]} ` }  ,
  {img:  Exhibition6   , type:`${headers[3]} ` }  ,
  {img:  Exhibition7   , type:`${headers[3]} ` }  ,
  ...
  {img: Branding3  , type:`${headers[4]} ` }  ,
  {img: Branding4  , type:`${headers[4]} ` }  ,
  {img: Branding5  , type:`${headers[4]} ` }  ,
  {img: Branding6  , type:`${headers[4]} ` }  ,
  ...
  {img:  Photography4   , type:`${headers[5]} ` }  ,
  {img:  Photography5   , type:`${headers[5]} ` }  ,
  {img:  Photography6   , type:`${headers[5]} ` }  ,
  {img:  Photography7   , type:`${headers[5]} ` }  ,

...
export const ImageGalleryHome = [
  ...
  {img:  Exhibition3 , type:`Exhibition all` , alt:"Sophisticated boutique Exhibition stand with curved wooden details  "  }  ,
  {img:  Exhibition4 , type:`Exhibition all` , alt:"Futuristic exhibition space with white and blue lighting.  "  }  ,
  {img:  Exhibition5 , type:`Exhibition all` , alt:"Elegant exhibition stand with flowing golden accents  "  }  ,
  ...
  {img:  Photography3 , type:`photography all`  , alt:"photography of a modern building at sunset  "  }  ,
  {img:  Photography4 , type:`photography all`  , alt:"photography of an opulent home exterior  "  }  ,
  {img:  Photography5 , type:`photography all`  , alt:"Fashion photography of a woman in chic winter attire  "  }  ,
  ...
  {img: webDesign3 , type:`Web all` , alt:"Creative website on laptop and phone  "  }  ,
  {img: webDesign4 , type:`Web all` , alt:"Beauty services website on multiple devices  "  }  ,
  {img: webDesign5 , type:`Web all` , alt:"Creative portfolio website on laptop and phone  "  }  ,
  {img: webDesign6 , type:`Web all` , alt:"Laptop and phone showcasing coffee website  "  }  ,
  
  {img: giftItem1  , type:`Gifts all` }  ,
  {img: giftItem2  , type:`Gifts all` }  ,
  {img: giftItem3  , type:`Gifts all` }  ,
...
export const ImageGalleryIndoor = [
  ...
  {img:  Health4 , type:`Health-safety all` }  ,
  {img:  Health5 , type:`Health-safety all` }  ,
  {img:  Health6 , type:`Health-safety all` }  ,

  {img:  Menu1 , type:`Menu-boards all` }  ,
  {img:  Menu2 , type:`Menu-boards all` }  ,
  {img:  Menu3 , type:`Menu-boards all` }  ,
  {img:  Menu4 , type:`Menu-boards all` }  ,
  {img:  Menu5 , type:`Menu-boards all` }  ,
  {img:  Menu6 , type:`Menu-boards all` }  ,
  ...
  {img: officeSign1 , type:`Office-signs all` }  ,
  {img: officeSign2 , type:`Office-signs all` }  ,
  {img: officeSign3 , type:`Office-signs all` }  ,
...
export const ImageGalleryGifts = [
  ...
  {img: Tropihes2 , type:`trophies all`  , alt:"Sparkling crystall award" , titleImg:"crystal flame trophy"  }  ,
  {img: Tropihes3 , type:`trophies all`  , alt:"Contemporary glass trophy" , titleImg:"Modern Achievement trophy"  }  ,
  {img: Tropihes4 , type:`trophies all`  , alt:"Sparkling crystal award" , titleImg:"Crystal Flame Tropjy"  }  ,
  {img: Tropihes5 , type:`trophies all`  , alt:"set of winner medals " , titleImg:" champion medals trio"  }  ,
  {img: Tropihes6 , type:`trophies all`  , alt:"Shiny gold medal ribbon" , titleImg:"Golden victory medal"  }  ,
  
  {img: giftItem1  , type:`gift-Item all` }  ,
  {img: giftItem2  , type:`gift-Item all` }  ,
...
export const  ImageGalleryBranding = [
  ...
  {img:  Logo1 , alt:"" , type:`Logo all` }  ,
  {img:  Logo2 , alt:"" , type:`Logo all` }  ,
  ...
  {img: webDesign3  , type:`Web all` }  ,
  {img: webDesign4  , type:`Web all` }  ,
  {img: webDesign5  , type:`Web all` }  ,
  {img: webDesign6  , type:`Web all` }  ,

  {img: SocialMedia1  , type:`Socialmedia all` , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
  {img: SocialMedia2  , type:`Socialmedia all` , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
  {img: SocialMedia3  , type:`Socialmedia all` , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
  {img: SocialMedia4  , type:`Socialmedia all` , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
  {img: SocialMedia5  , type:`Socialmedia all` , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
  {img: SocialMedia6  , type:`Socialmedia all` , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
  {img: SocialMedia7  , type:`Socialmedia all` , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,
  {img: SocialMedia8  , type:`Socialmedia all` , titleImg:"Engaging-Online-Branding" , alt:"Phone with social media event promotion  "}  ,

  {img: Packaging1 , type:`packaging all` }  ,
  ...
  {img: stationery3 , type:`stationery all`  , alt:"Elegant black and gold branding set"}  ,
  {img: stationery4 , type:`stationery all`  , alt:"Elegant black and gold branding set"}  ,

...
export const ImageGalleryHome = [
  ...
  {img:  Sign1 ,type2:"Signages" , type:`Signages` }  ,
  {img:  Sign2 ,type2:"Signages" , type:`Signages` }  ,
  {img:  Sign3 ,type2:"Signages" , type:`Signages` }  ,
  {img:  Sign4 ,type2:"Signages" , type:`Signages all ` }  ,
  {img:  Sign5 ,type2:"Signages" , type:`Signages all ` }  ,
  {img:  Sign6 ,type2:"Signages" , type:`Signages ` }  ,
  {img:  Sign7 ,type2:"Signages" , type:`Signages ` }  ,


  {img: DisplayStand1 , type2:"Displaystands" , alt:"Modern pharmacy display stand with illuminated shelving  "  , type:`Displaystands ` }  ,
  {img: DisplayStand2 , type2:"Displaystands" , alt:"Elegant jewelry store interior with display cases  "  , type:`Displaystands ` }  ,
  {img: DisplayStand3 , type2:"Displaystands" , alt:"contemporary store display stand design   "  , type:`Displaystands all` }  ,
  {img: DisplayStand4 , type2:"Displaystands" , alt:"cosmetic display stand  with greenery accents  "  , type:`Displaystands all` }  ,
  {img: DisplayStand6 , type2:"Displaystands" , alt:" Display stand makeup shelves with bold imagery.  "  , type:`Displaystands ` }  ,
  {img: DisplayStand7 , type2:"Displaystands" , alt:"Stylish beauty product display stand in an elegant store  "  , type:`Displaystands ` }  ,


  {img:  Exhibition1, type2:"Exhibition" , alt:"Modern exhibit booth with striking black and gold design  "  , type:`Exhibition ` }  ,
  {img:  Exhibition2, type2:"Exhibition" , alt:"Chic jewelry Exhibition stand with luxurious white decor.  "  , type:`Exhibition ` }  ,
  {img:  Exhibition3, type2:"Exhibition" , alt:"Sophisticated boutique Exhibition stand with curved wooden details  "  , type:`Exhibition ` }  ,
  {img:  Exhibition4, type2:"Exhibition" , alt:"Futuristic exhibition space with white and blue lighting.  "  , type:`Exhibition ` }  ,
  {img:  Exhibition5, type2:"Exhibition" , alt:"Elegant exhibition stand with flowing golden accents  "  , type:`Exhibition all` }  ,
  {img:  Exhibition6, type2:"Exhibition" , alt:"Opulent event booth with overhead golden chandelier  "  , type:`Exhibition all` }  ,
  {img:  Exhibition7, type2:"Exhibition" , alt:"Contemporary lounge area within a Exhibition stand.  "  , type:`Exhibition all` }  ,
  {img:  Exhibition8, type2:"Exhibition" , alt:"Innovative tech exhibition stand with circular theme  "  , type:`Exhibition ` }  ,
  {img:  Exhibition9, type2:"Exhibition" , alt:"Boutique exhibition stand with curved wooden details  "  , type:`Exhibition ` }  ,

  {img: Branding1 , type2:"branding" ,alt:"Phone with social media event promotion  "         , type:`branding` }  ,
  {img: Branding2 , type2:"branding" ,alt:"Gold 'LUXURIOUS' text on a textured background.  " , type:`branding` }  ,
  {img: Branding3 , type2:"branding" ,alt:"Professionals from different industries  "         , type:`branding` }  ,
  {img: Branding4 , type2:"branding" ,alt:"Fleet of branded company vehicles"                 , type:`branding ` }  ,
  {img: Branding5 , type2:"branding" ,alt:"" , type:`branding all` }  ,
  {img: Branding6 , type2:"branding" ,alt:"" , type:`branding all` }  ,
  {img: Branding7 , type2:"branding" ,alt:"" , type:`branding` }  ,


  {img:  Photography1 , type2:"photography" , alt:"Interior photography of a cozy, well-lit restaurant  "  , type:`photography ` }  ,
  {img:  Photography2 , type2:"photography" , alt:"Event photography of a speaker engaging a large audience  "  , type:`photography ` }  ,
  {img:  Photography3 , type2:"photography" , alt:"photography of a modern building at sunset  "  , type:`photography ` }  ,
  {img:  Photography4 , type2:"photography" , alt:"photography of an opulent home exterior  "  , type:`photography ` }  ,
  {img:  Photography5 , type2:"photography" , alt:"Fashion photography of a woman in chic winter attire  "  , type:`photography all` }  ,
  {img:  Photography6 , type2:"photography" , alt:"Portrait photography of a professional man  "  , type:`photography all` }  ,
  {img:  Photography7 , type2:"photography" , alt:"Food photography of an artistic pasta dish  "  , type:`photography all` }  ,
  {img:  Photography8 , type2:"photography" , alt:"Product photography of an exquisite perfume bottle with splashes  "  , type:`photography ` }  ,
  {img:  Photography9 , type2:"photography" , alt:"Automotive photography of a futuristic green concept car  "  , type:`photography ` }  ,

  {img: webDesign1 , type2:"web" , alt:"Furniture website display on laptop and phone  "  , type:`Web ` }  ,
  {img: webDesign2 , type2:"web" , alt:"Houseplant care Website on laptop and mobile  "  , type:`Web ` }  ,
  {img: webDesign3 , type2:"web" , alt:"Creative website on laptop and phone  "  , type:`Web ` }  ,
  {img: webDesign4 , type2:"web" , alt:"Beauty services website on multiple devices  "  , type:`Web all` }  ,
  {img: webDesign5 , type2:"web" , alt:"Creative portfolio website on laptop and phone  "  , type:`Web all` }  ,
  {img: webDesign6 , type2:"web" , alt:"Laptop and phone showcasing coffee website  "  , type:`Web all` }  ,
...
export const ImageGalleryIndoor = [
  ...
  {img:  Lamppost5 , type:`Lamp-Post all` }  ,
  {img:  Lamppost6 , type:`Lamp-Post all` }  ,
    ...
    {img: Unipole1 , type:`unipole all` }  ,
    {img: Unipole2 , type:`unipole all` }  ,
    {img: Unipole3 , type:`unipole all` }  ,
...
export const ImageGalleryOutdoor = [
  ...
  {img:  Health1 , type:`health all` }  ,
  {img:  Health2 , type:`health all` }  ,
  {img:  Health3 , type:`health all` }  ,
  {img:  Health4 , type:`health all` }  ,
  {img:  Health5 , type:`health all` }  ,
  {img:  Health6 , type:`health all` }  ,

  {img:  Menu1 , type:`menu all` }  ,
  {img:  Menu2 , type:`menu all` }  ,
  {img:  Menu3 , type:`menu all` }  ,
  {img:  Menu4 , type:`menu all` }  ,
  {img:  Menu5 , type:`menu all` }  ,
  {img:  Menu6 , type:`menu all` }  ,

  {img: officeSign1 , type:`office all` }  ,
  {img: officeSign2 , type:`office all` }  ,
  {img: officeSign3 , type:`office all` }  ,
  {img: officeSign4 , type:`office all` }  ,
  {img: officeSign5 , type:`office all` }  ,
  {img: officeSign6 , type:`office all` }  ,
  
  {img: Reception1 , type:`reception all` }  ,
  {img: Reception2 , type:`reception all` }  ,
  {img: Reception3 , type:`reception all` }  ,
  {img: Reception4 , type:`reception all` }  ,
